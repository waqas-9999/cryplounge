...
const allNews = [
  {
    ...
    content:
      "The Aave DAO has proposed a comprehensive $50 million annual token buyback program that will be funded entirely by protocol revenue.",
    image:
      "https://www.tbstat.com/cdn-cgi/image/format=webp,q=50,w=500/wp/uploads/2024/08/20240819_Aave_News_2-1200x675.jpg",
  },
  {
    id: 2,
    title:
    ...
    category: "Policy",
    content:
      "Senator Elizabeth Warren has raised serious concerns about the proposed stablecoin legislation, calling for the Treasury Department to address potential conflicts of interest.",
    image:
      "https://www.tbstat.com/cdn-cgi/image/format=webp,q=50,w=300/wp/uploads/2021/09/20210927_Elizabeth_Warren_Generic-1200x675.jpg",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    category: "Finance",
    content:
      "The upcoming Finternet 2025 Summit in Asia will focus on compliant digital asset growth as a core agenda item.",
    image:
      "https://www.tbstat.com/cdn-cgi/image/format=webp,q=50/wp/uploads/2025/10/3f4023cf75a00509407be9343c3a7251-1200x675.jpg",
  },
  {
    id: 6,
    ...
    category: "Research",
    content:
      "Yellow represents a groundbreaking clearing network designed to unify fragmented blockchain ecosystems.",
    image:
      "https://www.tbstat.com/cdn-cgi/image/format=avif,q=50/wp/uploads/2025/10/20251007_Yellow_ResearchThumbnail-1200x675.jpg",
  },
  {
    id: 7,
  ...
  },
  {
    ...
    content:
      "Bitwise CIO Matt Hougan suggests that gold's recent performance may offer insights into Bitcoin's next major move.",
    image:
      "https://images.unsplash.com/photo-1620228457732-4b8c7a68e8e0?auto=format&fit=crop&w=1200&q=80",
  },
  {
    ...
    category: "Deals",
    content:
      "The National Hockey League (NHL) has entered into a landmark partnership with Kalshi and Polymarket.",
    image:
      "https://images.unsplash.com/photo-1629403914045-38e7dce4b30c?auto=format&fit=crop&w=1200&q=80",
  },
  {
    ...
    content:
      "FalconX has announced its intent to acquire 21Shares in one of the biggest crypto mergers of the year.",
    image:
      "https://images.unsplash.com/photo-1620301857561-04b4b7a0ebf9?auto=format&fit=crop&w=1200&q=80",
  },
];
...
const Category = () => {
  ...
  // ✅ If category is "all", show all news; else filter by category
  ...
  return (
    <div className="min-h-screen container mx-auto bg-[#0a0a0a] text-white py-10 px-8">
            ...
            {categoryArticles.map((article) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link
                    to={`/news/${article.id}/${article.title
                      .toLowerCase()
                      .replace(/\s+/g, "-")
                      .replace(/[^\w\-]+/g, "")}`}
                    className="block"
